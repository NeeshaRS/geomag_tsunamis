...
cz = cwt(ts,fliplr(Sc),waven);%Complex wavelet transform
...
figure(1)
imagesc(fday,fliplr(perd)/60,abs(cz(:,1:10:end)));
set(gca,'FontSize',16)
...
xlabel('Date')
ylabel('Period (min)')
title('2007 Kuril Islands-- T18 Z wavelet analysis (1/5-21/2007)')
